...
namespace {
void fun_print(int elem) { std::cout << elem << ' '; }

int fun_square(int elem) { return elem * elem; }

bool isGood(int score) { return score >= 80; }

bool selfSmaller(int a, int b) { return (a < b); }

bool selfBigger(int a, int b) { return (a > b); }
}  // namespace
...
void TEST::test_transform() {
    ...
    std::cout << "transform set to vector using fun_square and back_inserter"
              << std::endl;
    std::vector<int> v;
