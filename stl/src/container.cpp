...
void TEST::test_map() {
    cout << "test_map()" << endl;
    {
        ...
        cout << "m.lower_bound(\"Kitty\")->first=" << ref_lower_bound->first
             << endl;
        cout << "m.lower_bound(\"Kitty\")->second=" << ref_lower_bound->second
             << endl;
        const auto& ref_upper_bound = m.upper_bound("Kitty");
        cout << "m.upper_bound(\"Kitty\")->first=" << ref_upper_bound->first
             << endl;
        cout << "m.upper_bound(\"Kitty\")->second=" << ref_upper_bound->second
             << endl;
        const auto& ref_equal_range = m.equal_range("Kitty");
        cout << "m.equal_range(\"Kitty\").first->first="
             << ref_equal_range.first->first << endl;
        cout << "m.equal_range(\"Kitty\").second->first="
             << ref_equal_range.second->first << endl;
    }
    {
        map<string, int> m;
