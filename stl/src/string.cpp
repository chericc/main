...
void TEST::test_string_basic() {
    ...
    /* search */
    {
        ...
        cout << "(s0.find('b')==string::npos)="
             << (s0.find('b') == string::npos) << endl;
        ...
        cout << "s0.find_first_not_of(\"This \")="
             << s0.find_first_not_of("This ") << endl;
        cout << "s0.find_last_not_of(\"is amaing!\")="
             << s0.find_last_not_of("is amazing!") << endl;
    ...
    /* numeric conversion */
    {
        ...
        cout << R"(std::stoi(string("10ghi"), & idx, 16)=)"
             << std::stoi(string("10ghi"), &idx, 16) << " idx=" << idx << endl;

        cout << R"(std::stoi(string("10ghi"), & idx, 10)=)"
             << std::stoi(string("10ghi"), &idx, 10) << " idx=" << idx << endl;

        cout << R"(std::stoi(string("10ghi"), & idx, 8)=)"
             << std::stoi(string("10ghi"), &idx, 8) << " idx=" << idx << endl;

        cout << R"(std::stoi(string("10ghi"), & idx, 2)=)"
             << std::stoi(string("10ghi"), &idx, 2) << " idx=" << idx << endl;

        cout << R"(std::stof(string("10.001ghi"), & idx)=)"
             << std::stof(string("10.001ghi"), &idx) << " idx=" << idx << endl;

        cout << R"(std::stod(string("1.333e2ghi"), & idx)=)"
             << std::stod(string("1.333e2ghi"), &idx) << " idx=" << idx << endl;
        ...
        cout << "to_string: " << endl;
        cout << std::to_string(i0) << " + " << std::to_string(d0) << " = "
             << std::to_string(d1) << endl;
