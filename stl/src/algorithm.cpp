...
void TEST::test_algorithm_nonmodifying() {
    ...
    /* count */
    {
        ...
        std::cout << std::count_if(
            v.cbegin(), v.cend(),
            [](const int& ref) -> bool { return ref > 3; });
    ...
    /* min_element & max_element & minmax_element */
    {
        ...
        std::cout << "*min_element(v)="
                  << *std::min_element(v.cbegin(), v.cend()) << std::endl;
        std::cout << "*min_element(v, comp)="
                  << *std::min_element(
                         v.cbegin(), v.cend(),
                         [](const int& ref_a, const int& ref_b) -> bool {
                             return ref_a < ref_b;
                         })
                  << std::endl;
        std::cout << "*max_element(v)="
                  << *std::max_element(v.cbegin(), v.cend()) << std::endl;
        std::cout << "*max_element(v, comp)="
                  << *std::max_element(
                         v.cbegin(), v.cend(),
                         [](const int& ref_a, const int& ref_b) -> bool {
                             return ref_a < ref_b;
        ...
        std::cout << "*minmax_element(v).first=" << *(it_minmax_1.first)
                  << std::endl;
        std::cout << "*minmax_element(v).second=" << *(it_minmax_1.second)
                  << std::endl;
        std::cout << "*minmax_element(v, comp).first=" << *(it_minmax_2.first)
                  << std::endl;
        std::cout << "*minmax_element(v, comp).second=" << *(it_minmax_2.second)
                  << std::endl;
        std::cout << std::endl;
    }
    /* find & find_if & find_if_not */
    {
        ...
        std::vector<int> v{5, 3, 8, 8, 6};
        PRINT_ELEMENTES(v, "original vector");
        std::cout << "*find(v,3)=" << *std::find(v.cbegin(), v.cend(), 3)
                  << std::endl;
        std::cout << "*find_if(v, >5)="
                  << *std::find_if(
                         v.cbegin(), v.cend(),
                         [](const int& ref) -> bool { return ref > 5; })
                  << std::endl;
        std::cout << "*find_if_not(v, >5)="
                  << *std::find_if_not(
                         v.cbegin(), v.cend(),
                         [](const int& ref) -> bool { return ref > 5; })
                  << std::endl;
    ...
    /* search_n */
    {
        ...
        PRINT_ELEMENTES(v, "original vector");
        std::cout << "*search_n(v.cbegin(), v.cend(), 2, 7)="
                  << *std::search_n(v.cbegin(), v.cend(), 2, 7) << std::endl;
        std::cout << "*search_n(v.cbegin(), v.cend(), 2, 0, (elem+value)<5 = "
                  << *std::search_n(
                         v.cbegin(), v.cend(), 2, 0,
                         [](const int& ref_elem, const int& ref_value) -> bool {
                             return ref_elem + ref_value < 5;
                         })
                  << std::endl;
        std::cout << std::endl;
    }
    /* search */
    {
        ...
        std::cout << "*search(v.cbegin(), v.cend(), v2.cbegin(), v2.cend(), "
                     "op(ele-1==value))="
                  << *std::search(
                         v.cbegin(), v.cend(), v2.cbegin(), v2.cend(),
                         [](const int& ref_elem, const int& ref_value) -> bool {
                             return ref_elem - 1 == ref_value;
                         })
                  << std::endl;
        std::cout << std::endl;
    }
    /* find_end */
    {
        ...
        std::cout
            << "find_end finds the last section while search finds the first"
            << std::endl;
        std::cout << std::endl;
    }
    /* find_first_of */
    {
        ...
        std::cout
            << "*find_first_of(v.cbegin(), v.cend(), v2.cbegin(), v2.cend())="
            << *std::find_first_of(v.cbegin(), v.cend(), v2.cbegin(), v2.cend())
            << std::endl;
        std::cout << "*find_first_of(v.cbegin(), v.cend(), v2.cbegin(), "
                     "v2.cend(), op(a + b == 100))="
                  << *std::find_first_of(
                         v.cbegin(), v.cend(), v2.cbegin(), v2.cend(),
                         [](const int& ref_elem, const int& ref_value) -> bool {
                             return ref_elem + ref_value == 100;
                         })
                  << std::endl;
        std::cout << std::endl;
    }
    ...
    /* is_permutation */
    {
        ...
        std::cout << "is_permutation(v.cbegin(), v.cend(), v2.cbegin())="
                  << std::is_permutation(v.cbegin(), v.cend(), v2.cbegin())
                  << std::endl;
        std::cout
            << "is_permutation(v.cbegin(), v.cend(), v3.cbegin(), op(a+b==11))="
            << std::is_permutation(
                   v.cbegin(), v.cend(), v3.cbegin(),
                   [](const int& ref_elem, const int& ref_value) -> bool {
                       return ref_elem + ref_value == 11;
                   })
            << std::endl;
        std::cout << std::endl;
    }
    /* mismatch */
    {
        ...
        std::cout << "*mismatch(v.cbegin(), v.cend(), v2.cbegin()).first="
                  << *std::mismatch(v.cbegin(), v.cend(), v2.cbegin()).first
                  << std::endl;
        std::cout << "*mismatch(v.cbegin(), v.cend(), v2.cbegin()).second="
                  << *std::mismatch(v.cbegin(), v.cend(), v2.cbegin()).second
                  << std::endl;
        std::cout
            << "*mismatch(v.cbegin(), v.cend(), v2.cbegin(), op(a==b)).first="
            << *std::mismatch(
                    v.cbegin(), v.cend(), v2.cbegin(),
                    [](const int& ref_elem, const int& ref_value) -> bool {
                        return ref_elem == ref_value;
                    })
                    .first
            << std::endl;
        std::cout
            << "*mismatch(v.cbegin(), v.cend(), v2.cbegin(), op(a==b)).second="
            << *std::mismatch(
                    v.cbegin(), v.cend(), v2.cbegin(),
                    [](const int& ref_elem, const int& ref_value) -> bool {
                        return ref_elem == ref_value;
    ...
    /* lexicographical_compare */
    {
        ...
        PRINT_ELEMENTES(v2, "v2:");
        PRINT_ELEMENTES(v3, "v3:");
        std::cout << "lexicographical_compare(v.cbegin(), v.cend(), "
                     "v2.cbegin(), v2.cend())="
                  << std::lexicographical_compare(v.cbegin(), v.cend(),
                                                  v2.cbegin(), v2.cend())
                  << std::endl;
        std::cout << "lexicographical_compare(v.cbegin(), v.cend(), "
                     "v3.cbegin(), v3.cend())="
        ...
        std::cout << "lexicographical_compare(v.cbegin(), v.cend(), "
                  ...
                  << std::endl;
        std::cout << "lexicographical_compare(v.cbegin(), v.cend(), "
                     "v3.cbegin(), v3.cend(), op(a<b))="
                  << std::lexicographical_compare(
                         v.cbegin(), v.cend(), v3.cbegin(), v3.cend(),
                         [](const int& ref_elem, const int& ref_value) -> bool {
                             return ref_elem < ref_value;
                         })
                  << std::endl;
    ...
    /* all_of, any_of, none_of */
    {
        ...
        std::cout << "all_of(v.cbegin(), v.cend(), op(a<100))="
                  << std::all_of(
                         v.cbegin(), v.cend(),
                         [](const int& ref) -> bool { return ref < 100; })
                  << std::endl;
        ...
        std::cout << "none_of(v.cbegin(), v.cend(), op(a<0))="
                  << std::none_of(
                         v.cbegin(), v.cend(),
                         [](const int& ref) -> bool { return ref < 0; })
                  << std::endl;
        std::cout << std::endl;
    }
}
...
void TEST::test_algorithm_modifying() {
    /* copy */
    {
        ...
        std::vector<int> v1;
        std::cout << "copy(v.cbegin(), v.cend(), back_inserter(v1))"
                  << std::endl;
    ...
    /* copy_if */
    {
        ...
        PRINT_ELEMENTES(v, "v:");
        std::vector<int> v1;
        std::cout << "copy(v.cbegin(), v.cend(), back_inserted(v1), op(v<4))"
                  << std::endl;
    ...
    /* copy_n */
    {
        ...
        PRINT_ELEMENTES(v, "v:");
        std::vector<int> v2;
        std::cout << "copy_n(v.cbegin(), v.size()-1, back_inserter(v2))"
                  << std::endl;
    ...
    /* copy_backword */
    {
        ...
        std::cout << "copy_backward(v.cbegin(), v.cend(), v2.end())"
                  << std::endl;
    ...
    /* move, move_backward */
    {
        ...
        std::cout << "move_backward(v3.cbegin(), v3.cend(), v4.back())"
                  << std::endl;
    ...
    /* transform */
    {
        ...
        std::vector<int> v2;
        std::cout
            << "transform(v.cbegin(), v.cend(), back_inserter(v2), op(v+1))"
            << std::endl;
        ...
        PRINT_ELEMENTES(v4, "v4:");
        std::vector<int> v5;
        std::cout << "transform(v3.cbegin(), v3.cend(), v4.cbegin(), "
                     "back_inserter(v5), op(a+b))"
                  << std::endl;
        std::transform(v3.cbegin(), v3.cend(), v4.cbegin(),
                       std::back_inserter(v5),
                       [](const int& ref_a, const int ref_b) -> int {
                           return ref_a + ref_b;
                       });
    ...
    /* generate, generate_n */
    {
        ...
        std::vector<int> v2(5);
        std::cout << "generate_n(v.begin(), v.end(), op(++count%3))"
                  << std::endl;
        std::generate_n(v2.begin(), v2.size(),
                        [&count]() -> int { return ++count % 3; });
        PRINT_ELEMENTES(v2, "v2:");
    ...
    /* replace, replace_if */
    {
        ...
        std::cout << "replace_if(v2.begin(), v2.end(), op(a>2), 12)"
                  << std::endl;
        std::replace_if(
            v2.begin(), v2.end(),
    ...
    /* replace_copy, replace_copy_if */
    {
        ...
        std::vector<int> v3;
        std::cout
            << "replace_copy(v.cbegin(), v.cend(), back_inserter(v2), 3, 12)"
            << std::endl;
        std::replace_copy(v.cbegin(), v.cend(), std::back_inserter(v2), 3, 12);
        PRINT_ELEMENTES(v2, "v2:");
        std::cout << "replace_copy(v.cbegin(), v.cend(), back_inserter(v3), "
                     "op(a>2), 12)"
                  << std::endl;
        std::replace_copy_if(
            v.cbegin(), v.cend(), std::back_inserter(v3),
            [](const int& ref) -> bool { return ref > 2; }, 12);
        PRINT_ELEMENTES(v3, "v3:");
        std::cout << std::endl;
    }
...
void TEST::test_algorithm_removing() {
    ...
    /* remove, remove_if */
    {
        ...
        auto ret_remove_if = std::remove_if(
            v.begin(), v.end(), [](const int& ref) -> bool { return ref > 2; });
    ...
    /* remove_copy, remove_copy_if */
    {
        ...
        std::vector<int> v2;
        std::vector<int> v3;
        std::cout << "remove_copy(v.cbegin(), v.cend(), insert_iterator(v2), 3)"
                  << std::endl;
        std::remove_copy(v.cbegin(), v.cend(), std::back_inserter(v2), 3);
        PRINT_ELEMENTES(v2, "v2:");
        std::cout
            << "remove_copy_if(v.cbegin(), v.cend(), back_inserter(v3), op(>2))"
            << std::endl;
    ...
    /* unique_copy */
    {
        ...
        std::vector<int> v2;
        std::vector<int> v3;
        std::cout << "unique(v.cbegin(), v.cend(), back_inserter(v2))"
                  << std::endl;
        std::unique_copy(v.cbegin(), v.cend(), std::back_inserter(v2));
        PRINT_ELEMENTES(v2, "v2:");
        std::cout << "unique(v.cbegin(), v.cend(), back_inserter(v3), op(a==b))"
                  << std::endl;
...
void TEST::test_algorithm_mutating() {
    ...
    /* reverse, reverse_copy */
    {
        ...
        PRINT_ELEMENTES(v2, "v2:");
        std::vector<int> v3;
        std::cout << "reverse_copy(v2.cbegin(), v2.cend(), back_inserter(v3))"
                  << std::endl;
    ...
    /* rotate, rotate_copy */
    {
        ...
        PRINT_ELEMENTES(v2, "v2:");
        std::vector<int> v3;
        std::cout << "rotate_copy(v2.cbegin(), v2.cbegin()+2, v2.cend(), "
                     "back_inserter(v3))"
                  << std::endl;
        std::rotate_copy(v2.cbegin(), v2.cbegin() + 2, v2.cend(),
    ...
    /* next_permutation */
    {
        ...
        std::vector<int> v2{1, 2, 3, 4, 5, 6, 7, 8, 9};
        PRINT_ELEMENTES(v2, "v2:");
        std::cout << "next_permutation(v.begin(), v.end(), op(a<b))"
                  << std::endl;
        std::next_permutation(v.begin(), v.end(),
                              [](const int& ref_a, const int& ref_b) -> bool {
                                  return ref_a < ref_b;
    ...
    /* prev_permutation */
    {
        ...
        std::vector<int> v2{1, 2, 3, 4, 5, 6, 7, 8, 9};
        PRINT_ELEMENTES(v2, "v2:");
        std::cout << "prev_permutation(v.begin(), v.end(), op(a<b))"
                  << std::endl;
        std::prev_permutation(v.begin(), v.end(),
                              [](const int& ref_a, const int& ref_b) -> bool {
                                  return ref_a < ref_b;
    ...
    /* shuffle, random_shuffle */
    {
        ...
        std::vector<int> v{1, 2, 3, 4, 5, 6, 7, 8, 9};
        PRINT_ELEMENTES(v, "v:");
        std::cout << "shuffle(v.begin(), v.end(), default_random_engine)"
                  << std::endl;
    ...
    /* partition, stable_partition */
    {
        ...
        std::vector<int> v2{1, 2, 3, 4, 5};
        PRINT_ELEMENTES(v2, "v2:");
        std::cout << "stable_partition(v.begin(), v.end(), op(a>3))"
                  << std::endl;
    ...
    /* partition_copy */
    {
        ...
        std::vector<int> v2;
        std::vector<int> v3;
        std::cout << "partition_copy(v.cbegin(), v.cend(), back_inserter(v2), "
                     "back_inserter(v3), op(a%2 == 0)"
                  << std::endl;
        std::partition_copy(v.cbegin(), v.cend(), std::back_inserter(v2),
                            std::back_inserter(v3), [](const int& ref) -> bool {
                                return ref % 2 == 0;
                            });
        PRINT_ELEMENTES(v2, "v2:");
        PRINT_ELEMENTES(v3, "v3:");
...
void TEST::test_algorithm_sorting() {
    ...
    /* partial_sort, partial_sort_copy */
    {
        ...
        std::vector<int> v2 = v;
        PRINT_ELEMENTES(v2, "v2:");
        std::cout << "partial_sort(v2.begin(), v2.begin() + 5, v2.end())"
                  << std::endl;
        ...
        PRINT_ELEMENTES(v3, "v3:");
        std::cout
            << "partial_sort(v3.begin(), v3.begin() + 5, v3.end(), op(a>b))"
            << std::endl;
        ...
        PRINT_ELEMENTES(v4, "v4:");
        std::cout
            << "partial_sort_copy(v4.cbegin(), v4.cend(), v5.begin(), v5.end())"
            << std::endl;
        ...
        std::cout << "partial_sort_copy(v4.cbegin(), v4.cend(), v5.begin(), "
                     "v5.end(), op(a>b))"
                  << std::endl;
    ...
    /* nth_element */
    {
        ...
        std::vector<int> v2 = v;
        PRINT_ELEMENTES(v2, "v2:");
        std::cout << "nth_element(v2.begin(), v2.begin()+4, v2.end())"
                  << std::endl;
        ...
        std::vector<int> v3 = v;
        PRINT_ELEMENTES(v3, "v3:");
        std::cout << "nth_element(v3.begin(), v3.begin()+4, v3.end(), op(a>b))"
                  << std::endl;
...
void TEST::test_algorithm_sortedrange() {
    ...
    /* binnary_search */
    {
        ...
        std::sort(v2.begin(), v2.end());
        PRINT_ELEMENTES(v2, "v2:");
        std::cout << "binary_search(v.cbegin(), v.cend(), 5)="
                  << std::binary_search(v.cbegin(), v.cend(), 5) << std::endl;
        std::cout << "binary_search(v.cbegin(), v.cend(), 100)="
                  << std::binary_search(v.cbegin(), v.cend(), 100) << std::endl;
    ...
    /* includes */
    {
        ...
        std::cout << "includes(v2.cbegin(), v2.cend(), v3.cbegin(), v3.cend())="
                  << std::includes(v2.cbegin(), v2.cend(), v3.cbegin(),
                                   v3.cend())
                  << std::endl;

        std::cout << "includes(v2.cbegin(), v2.cend(), v5.cbegin(), v5.cend())="
                  << std::includes(v2.cbegin(), v2.cend(), v5.cbegin(),
                                   v5.cend())
                  << std::endl;

        auto reverse_com = [](const int& ref_a, const int& ref_b) -> bool {
            return ref_a > ref_b;
        };
        sort(v2.begin(), v2.end(), reverse_com);
        PRINT_ELEMENTES(v2, "v2:");
        std::cout << "includes(v2.cbegin(), v2.cend(), v4.cbegin(), v4.cend(), "
                     "op(a>b))="
                  << std::includes(v2.cbegin(), v2.cend(), v4.cbegin(),
                                   v4.cend(), reverse_com)
                  << std::endl;

        std::cout << "includes(v2.cbegin(), v2.cend(), v6.cbegin(), v6.cend(), "
                     "op(a>b))="
                  << std::includes(v2.cbegin(), v2.cend(), v6.cbegin(),
                                   v6.cend(), reverse_com)
                  << std::endl;
    ...
    /* lower_bound, upper_bound */
    {
        ...
        std::cout << "*lower_bound(v.cbegin(), v.cend(), 5, reverse_com)="
                  << *std::lower_bound(v.cbegin(), v.cend(), 5, reverse_com)
                  << std::endl;
        std::cout << "*upper_bound(v.cbegin(), v.cend(), 5, reverse_com)="
                  << *std::upper_bound(v.cbegin(), v.cend(), 5, reverse_com)
                  << std::endl;
    ...
    /* equal_range */
    {
        ...
        std::cout << "*equal_range(v.cbegin(), v.cend(), 5).first="
                  << *range.first << std::endl;
        std::cout << "*equal_range(v.cbegin(), v.cend(), 5).second="
                  << *range.second << std::endl;

        auto reverse_comp = [](const int& ref_a, const int ref_b) -> bool {
            return ref_a > ref_b;
        };
        std::sort(v.begin(), v.end(), reverse_comp);
        PRINT_ELEMENTES(v, "v:");
        auto reverse_range =
            std::equal_range(v.cbegin(), v.cend(), 5, reverse_comp);
        std::cout << "*equal_range(v.cbegin(), v.cend(), 5, op(a>b)).first="
                  << *reverse_range.first << std::endl;
        std::cout << "*equal_range(v.cbegin(), v.cend(), 5, op(a>b)).second="
                  << *reverse_range.second << std::endl;
    ...
    /* merge */
    {
        ...
        std::cout << "merge(v.cbegin(), v.cend(), v2.cbegin(), v2.cend(), "
                     "back_inserter(v3))"
                  << std::endl;
        ...
        std::cout << "merge(v4.cbegin(), v4.cend(), v5.cbegin(), v5.cend(), "
                     "back_inserter(v6), op(a>b))"
                  << std::endl;
        std::merge(v4.cbegin(), v4.cend(), v5.cbegin(), v5.cend(),
                   std::back_inserter(v6), reverse_comp);
        PRINT_ELEMENTES(v6, "v6:");
    ...
    /* set_union */
    {
        ...
        std::cout << "set_union(v.cbegin(), v.cend(), v2.cbegin(), v2.cend(), "
                     "back_inserter(v3))"
                  << std::endl;
        ...
        std::cout << "set_union(v4.cbegin(), v4.cend(), v5.cbegin(), "
                     "v5.cend(), back_inserter(v6), op(a>b))"
                  << std::endl;
        std::set_union(v4.cbegin(), v4.cend(), v5.cbegin(), v5.cend(),
                       std::back_inserter(v6), reverse_comp);
        PRINT_ELEMENTES(v6, "v6:");
    ...
    /* set_intersection */
    {
        ...
        std::cout << "set_intersection(v.cbegin(), v.cend(), v2.cbegin(), "
                     "v2.cend(), back_inserter(v3))"
                  << std::endl;
        ...
        std::cout << "set_intersection(v4.cbegin(), v4.cend(), v5.cbegin(), "
                     "v5.cend(), back_inserter(v6), op(a>b))"
                  << std::endl;
        std::set_intersection(v4.cbegin(), v4.cend(), v5.cbegin(), v5.cend(),
                              std::back_inserter(v6), reverse_comp);
        PRINT_ELEMENTES(v6, "v6:");
    ...
    /* set_difference */
    {
        ...
        std::cout << "set_difference(v.cbegin(), v.cend(), v2.cbegin(), "
                     "v2.cend(), back_inserter(v3))"
                  << std::endl;
        ...
        std::cout << "set_difference(v4.cbegin(), v4.cend(), v5.cbegin(), "
                     "v5.cend(), back_inserter(v6), op(a>b))"
                  << std::endl;
        std::set_difference(v4.cbegin(), v4.cend(), v5.cbegin(), v5.cend(),
                            std::back_inserter(v6), reverse_comp);
        PRINT_ELEMENTES(v6, "v6:");
    ...
    /* set_symmetric_difference */
    {
        ...
        std::cout << "set_symmetric_difference(v.cbegin(), v.cend(), "
                     "v2.cbegin(), v2.cend(), back_inserter(v3))"
                  << std::endl;
        std::set_symmetric_difference(v.cbegin(), v.cend(), v2.cbegin(),
                                      v2.cend(), std::back_inserter(v3));
        PRINT_ELEMENTES(v3, "v3:");
        ...
        std::cout << "set_symmetric_difference(v4.cbegin(), v4.cend(), "
                     "v5.cbegin(), v5.cend(), back_inserter(v6), op(a>b))"
                  << std::endl;
        std::set_symmetric_difference(v4.cbegin(), v4.cend(), v5.cbegin(),
                                      v5.cend(), std::back_inserter(v6),
                                      reverse_comp);
        PRINT_ELEMENTES(v6, "v6:");
    ...
    /* inplace_merge */
    {
        ...
        PRINT_ELEMENTES(v, "v:");
        std::cout << "inplace_merge(v.begin(), v.begin() + 5, v.end())"
                  << std::endl;
...
void TEST::test_algorithm_numeric() {
    ...
    /* inner_product */
    {
        ...
        std::cout << "inner_product(v.cbegin(), v.cend(), v2.cbegin(), 10)="
                  ...
                  << std::endl;
        std::cout << "inner_product(v.cbegin(), v.cend(), v2.cbegin(), 10, "
                     "op1(return a+b), op2(return a*b))="
                  << std::inner_product(
                         v.cbegin(), v.cend(), v2.cbegin(), 10,
                         [](const int& ref_a, const int& ref_b) -> int {
                             return ref_a + ref_b;
                         },
                         [](const int& ref_a, const int& ref_b) -> int {
    ...
    /* partial_sum */
    {
        ...
        std::vector<int> v2;
        PRINT_ELEMENTES(v, "v:");
        std::cout << "partial_sum(v.cbegin(), v.cend(), back_inserter(v2))"
                  << std::endl;
        ...
        std::vector<int> v3;
        std::cout
            << "partial_sum(v.cbegin(), v.cend(), back_inserter(v2), op(a+b))"
            << std::endl;
    ...
    /* adjacent_difference */
    {
        ...
        PRINT_ELEMENTES(v, "v:");
        std::cout
            << "adjacent_differenct(v.cbegin(), v.cend(), back_inserter(v2))"
            << std::endl;
        std::adjacent_difference(v.cbegin(), v.cend(), std::back_inserter(v2));
        PRINT_ELEMENTES(v2, "v2:");

        std::vector<int> v3;
        std::cout << "adjacent_difference(v.cbegin(), v.cend(), "
                     "back_inserter(v2), op(a-b))"
                  << std::endl;
        std::adjacent_difference(v.cbegin(), v.cend(), std::back_inserter(v2),
                                 [](const int& ref_a, const int& ref_b) -> int {
                                     return ref_a - ref_b;
