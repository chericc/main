...
void TestType() {
    ...
    cout << "is_member_object_pointer=" << std::is_member_object_pointer<_T>()
         << endl;
    cout << "is_member_function_pointer="
         << std::is_member_function_pointer<_T>() << endl;
    ...
    cout << "is_trivially_copyable=" << std::is_trivially_copyable<_T>()
         << endl;
...
void TestClassType() {
    ...
    cout << "has_virtual_destructor=" << std::has_virtual_destructor<_T>()
         << endl;
    cout << "is_default_constructible=" << std::is_default_constructible<_T>()
         << endl;
    cout << "is_copy_constructible=" << std::is_nothrow_copy_constructible<_T>()
         << endl;
    cout << "is_move_constructible=" << std::is_move_constructible<_T>()
         << endl;
    cout << "is_destructoble=" << std::is_destructible<_T>() << endl;
    cout << "is_trivially_default_constructible="
         << std::is_trivially_default_constructible<_T>() << endl;
    cout << "is_trivially_copy_constructible="
         << std::is_trivially_copy_constructible<_T>() << endl;
    cout << "is_trivially_move_constructible="
         << std::is_trivially_move_constructible<_T>() << endl;
    cout << "is_trivially_copy_assignable="
         << std::is_trivially_copy_assignable<_T>() << endl;
    cout << "is_trivially_move_assignable="
         << std::is_trivially_move_assignable<_T>() << endl;
    cout << "is_trivially_destructible=" << std::is_trivially_destructible<_T>()
         << endl;
    cout << "is_nothrow_default_constructible="
         << std::is_nothrow_default_constructible<_T>() << endl;
    cout << "is_nothrow_copy_constructible="
         << std::is_nothrow_copy_constructible<_T>() << endl;
    cout << "is_nothrow_move_constructible="
         << std::is_nothrow_move_constructible<_T>() << endl;
    cout << "is_nothrow_copy_assignable="
         << std::is_nothrow_copy_assignable<_T>() << endl;
    cout << "is_nothrow_move_assignable="
         << std::is_nothrow_move_assignable<_T>() << endl;
    cout << "is_nothrow_destructible=" << std::is_nothrow_destructible<_T>()
         << endl;
}
...
void TEST::test_typetrait_const() {
    ...
    cout << "const volatile int=" << std::is_const<const volatile int>()
         << endl;
...
void TEST::test_typetrait_relation() {
    ...
    cout << "is_base_of<ostream, iostream>()="
         << std::is_base_of<std::ostream, std::iostream>() << endl;
    cout << "is_convertible<char *, string>()="
         << std::is_convertible<char*, std::string>() << endl;
    cout << "is_constructible<string, char, int>()="
         << std::is_constructible<std::string, char, int>() << endl;
    cout << "is_trivially_constructible<int, int>()="
         << std::is_trivially_constructible<int, int>() << endl;
    cout << "is_nothrow_constructible<int,int>()="
         << std::is_nothrow_constructible<int, int>() << endl;
    cout << "is_assignable<string, char *>()="
         << std::is_assignable<std::string, char*>() << endl;
    cout << "is_trivially_assignable<string, char *>()="
         << std::is_trivially_assignable<std::string, char*>() << endl;
    cout << "is_nothrow_assignable<string, char *>()="
         << std::is_nothrow_assignable<std::string, char*>() << endl;
