...
void leak_new_big() { new (BigMem); }

void leak_new_small() { new (SmallMem); }

void leak_newa_big() { new (unsigned char[LEAK_SIZE_BIG]); }

void leak_newa_small() { new (unsigned char[LEAK_SIZE_SMALL]); }
