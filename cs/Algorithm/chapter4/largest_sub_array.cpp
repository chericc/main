 ...
 */
static int alg_largest_sub_array_exhaustive(const std::vector<int>& v,
 ...
 */
static int alg_largest_sub_array_dc_helper(const std::vector<int>& v,
                                           std::pair<size_t, size_t>& be,
                                           std::pair<size_t, size_t>& index) {
    ...
    /**
     * If we divide the array into two parts, there are only three conditions.
     * First, the largest-sub-array is in the left part. Second, the
     * largest-sub-array is in the right part. Third, the largest-sub-array's
 ...
 */
static int alg_largest_sub_array_divide_and_conquer(
    const std::vector<int>& v, std::pair<size_t, size_t>& index) {
...
int main() {
    /**
     * 17 days stock price.
     * The best choice is to buy at day 7 and sell at day 11. We will get a
     * difference of 106 - 63 = 43.
     */
    std::vector<int> v = {100, 113, 110, 85,  105, 102, 86, 63, 81,
    ...
    std::cout << "result: " << pairResult1.first << "," << pairResult1.second
              << std::endl;
    ...
    std::cout << "result: " << pairResult2.first << "," << pairResult2.second
              << std::endl;
