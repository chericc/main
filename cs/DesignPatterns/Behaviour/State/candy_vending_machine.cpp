...
NoCoinState::NoCoinState(CandyVendingMachine *machine)
    : p_machine__(machine)
{
}
...
void ContainsCoinState::insertCoin()
{
...
void ContainsCoinState::dispense()
{
...
{
    PRINT("No candies avalable\n");
}

void NoCandyState::pressButton()
{
    PRINT("No candies avalable\n");
}
