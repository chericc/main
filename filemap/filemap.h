 ...
 * @note 应先检查是否存在
 */
int filemap_getitem(FILEMAP_HANDLE hInstance, const FILEMAP_KEY* key,
                    FILEMAP_VALUE* value);
 ...
 * @note 如果表已满，则无法添加
 */
int filemap_setitem(FILEMAP_HANDLE hInstance, const FILEMAP_KEY* key,
                    const FILEMAP_VALUE* value);
