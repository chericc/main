...
#define XLOG_ALLOW_INF (~((unsigned int)XLOG_LEVEL_TRACE | XLOG_LEVEL_DEBUG \
                        | XLOG_LEVEL_LOG))
#define XLOG_ALLOW_WAR (~((unsigned int)XLOG_LEVEL_TRACE | XLOG_LEVEL_DEBUG \
                        | XLOG_LEVEL_LOG | XLOG_LEVEL_INFORMATION))
#define XLOG_ALLOW_ERR (~((unsigned int)XLOG_LEVEL_TRACE | XLOG_LEVEL_DEBUG \
                        | XLOG_LEVEL_LOG | XLOG_LEVEL_INFORMATION | XLOG_LEVEL_WARNING))
...
#define xlog_war(...) xlog(XLOG_LEVEL_WARNING, __FILE__, __LINE__, __FUNCTION__, ##__VA_ARGS__)
