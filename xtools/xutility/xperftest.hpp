...
#define X_PERIOD_PRINT_TRC(desc, objname) \
    XPeriodPrint objname(__FILE__,__LINE__,__FUNCTION__,XLOG_LEVEL_TRACE, desc)
#define X_PERIOD_PRINT_DBG(desc, objname) \
    XPeriodPrint objname(__FILE__,__LINE__,__FUNCTION__,XLOG_LEVEL_DEBUG, desc)
...
#define X_PERIOD_PRINT_INF(desc, objname) \
    XPeriodPrint objname(__FILE__,__LINE__,__FUNCTION__,XLOG_LEVEL_INFORMATION, desc)
#define X_PERIOD_PRINT_ERR(desc, objname) \
    XPeriodPrint objname(__FILE__,__LINE__,__FUNCTION__,XLOG_LEVEL_ERROR, desc)
#define X_PERIOD_PRINT_CRI(desc, objname) \
    XPeriodPrint objname(__FILE__,__LINE__,__FUNCTION__,XLOG_LEVEL_CRITICAL, desc)
